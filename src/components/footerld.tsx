function Footer() {
  return (
    <footer className="w-full px-4 py-8 bg-gray-100 mt-20">
      <div className="grid grid-cols-4 mt-20 ">
        <div>
          <div className="grid gap-4 ml-24">
            <div>
        ...
        <div>
          {" "}
          <h3 className="font-semibold text-lg mb-4">Extra Links</h3>
          <ul className="space-y-2">
            <li>
              <a href="#" className="text-gray-600 hover:text-gray-800">
                Customer Support
        ...
        <div className="col-span-4 mt-8 border-t border-gray-200 pt-8 text-center j">
