        ...
        <div className="flip-card">
          <div className="flip-card-inner">
            <div className="flip-card-front">
              <div className="relative hover: bg-blue-950 max-w-sm p-6 border border-gray-200 rounded-3xl shadow dark:bg-gray-800 dark:border-gray-700 flex flex-col items-center justify-center">
                {/* <div className="absolute bg-red-600 w-1/2 h-full "></div> */}
                <div className="absolute w-[80px] h-[120px] top-0 right-1/2 left-7 translate-x-1/2 bg-gradient-to-t from-gray-950 to-blue-400"></div>
                <div className="absolute w-[80px] h-[120px] bottom-0 right-1/2 left-7 translate-x-1/2 bg-gradient-to-t from-blue-400 to-gray-950"></div>
                  ...
                  <div>
                    ...
                    <div className="flex mt-5">
                      ...
                      <div className="col-span-1">
                        <p className="font-bold text-blue-500 text-xs">Phone</p>
                    ...
                    <div className="flex">
                      ...
                      <div className="col-span-1">
                        <p className="font-bold text-blue-500 text-xs">Email</p>
                        <p className="font-bold text-white text-xs">
                          user@gmail.com
                        </p>
                        <hr style={{}} className="solid-vertical" />
